...
// Test that XAL operates correctly as a token with BetaDelegatedTransfer.
contract('BetaDelegatedTransfer XAL', function ([_, admin, owner, executor, recipient, whitelister, bystander]) {
  ...
  beforeEach(async function () {
    ...
    await proxiedXAL.initializeDomainSeparator({from: owner});
